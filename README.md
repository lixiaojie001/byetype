...
ByeType 是一个轻量级桌面应用，目标是**用语音输入完全取代键盘打字** — 无论是写文档、回消息、写代码注释还是填表单，所有需要打字的地方都可以直接说出来。通过全局快捷键触发录音，AI 将语音实时转录为文本并自动粘贴到光标位置。它的核心特色是**提示词驱动的高可定制性** — 通过编辑 Markdown 格式的提示词文件，你可以自定义转录的各种行为：
