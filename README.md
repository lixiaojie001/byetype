...
- 自动单位调整 — 说"这个项目预算大概三千五百万"，输出"这个项目预算大概 3500 万"
- 专有词汇校正 — 说"我们用的是deep seek的模型跑在苹果的mac book pro上"，输出"我们用的是 DeepSeek 的模型跑在 Apple 的 MacBook Pro 上"
- 口语清理 — 说"嗯……就是说那个我觉得吧这个方案其实还是可以的"，输出"我觉得这个方案还是可以的"
- 符号口令 — 说"请在周五前提交报告逗号sincerely逗号张三"，输出"请在周五前提交报告，sincerely，张三"
